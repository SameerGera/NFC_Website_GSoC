...
function Row({ icon, label, value, href }: RowProps) {
  ...
  if (href) {
    return (
      <a href={href} target="_blank" rel="noopener noreferrer" className="block transition hover:bg-primary-bg rounded-xl px-2 -mx-2">
        {content}
      </a>
    );
  }
  ...
  return (
    <div className="rounded-2xl bg-card border border-card-border p-5">
      <div className="mb-2 flex items-center gap-2.5">
        ...
        <h2 className="text-base font-semibold text-text-primary">Club Role</h2>
      </div>
      ...
      <div className="divide-y divide-card-border">
        <Row
          ...
          label="Email"
          value={`${member.memberId.toLowerCase()}@gsock.tech`}
        ...
        {member.portfolio && (
          <Row
            ...
            label="Portfolio"
            value={member.department + " Web Team"}
