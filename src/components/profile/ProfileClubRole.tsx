...
/** Extract a readable label from a URL (e.g. "github.com/user" → "user") */
      ...
      <div className="divide-y divide-card-border/50">
        ...
        {member.linkedin && (
          <Row
            ...
            label="LinkedIn"
            value={extractUrlLabel(member.linkedin, "LinkedIn")}
        ...
        {member.github && (
          <Row
            ...
            label="GitHub"
            value={extractUrlLabel(member.github, "GitHub")}
            href={member.github}
          />
        )}
        {member.portfolio && (
          <Row
            ...
            label="Portfolio"
            value={extractUrlLabel(member.portfolio, "Portfolio")}
