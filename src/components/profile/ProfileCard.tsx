...
export default function ProfileCard({ member }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-2 pt-4 pb-3">
      <div className="relative h-20 w-20 overflow-hidden rounded-full border-[3px] border-primary/30 bg-primary-bg">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <svg className="h-4 w-4 text-verified" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div className="text-center text-xs text-text-secondary leading-relaxed">
        <p>{member.department} Department, {member.year} &middot; {member.clubrole}</p>
      </div>
      ...
      <div className="mt-0.5 flex items-center gap-3">
        {member.github && (
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-primary/10 text-primary transition active:scale-95"
          >
